...
export default function Footer() {
    return (
        <footer className="bg-white dark:bg-slate-900 border-y">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <Link to="/" className="flex items-center">
                            <img
                                ...
                                alt="Logo"
                            />
                            <span className='text-3xl font-bold italic dark:text-white'  >Sport<span className='text-blue-700'>i</span>fy</span>
                        </Link>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 dark:text-white">
                        <div>
                            ...
                            <ul className="text-gray-500 dark:text-slate-300 font-medium">
                                <li className="mb-4">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-500 dark:text-slate-300 font-medium">
                                <li className="mb-4">
                                    <a
                                        href="https://github.com/SilentWatcher"
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                        <Link to="#" className="text-gray-500 dark:text-slate-300 hover:text-gray-900">
                            <svg
                                className="w-4 h-4"
                                aria-hidden="true"
                        ...
                        <Link to="#" className="text-gray-500 dark:text-slate-300">
                            <svg
                                className="w-4 h-4"
                                aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg"
